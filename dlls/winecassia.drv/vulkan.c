...
static void *CASSIA_get_vk_device_proc_addr(const char *name);
static void *CASSIA_get_vk_instance_proc_addr(VkInstance instance, const char *name);
...
static VkResult CASSIA_vkAcquireNextImage2KHR(VkDevice device, const VkAcquireNextImageInfoKHR *acquire_info,
...
static VkResult CASSIA_vkAcquireNextImageKHR(VkDevice device, VkSwapchainKHR swapchain, uint64_t timeout,
    ...
    return CASSIA_vkAcquireNextImage2KHR(device, &acquire_info, image_index);
}
...
static VkResult CASSIA_vkCreateDevice(VkPhysicalDevice physical_device, const VkDeviceCreateInfo *create_info,
...
static VkResult CASSIA_vkCreateInstance(const VkInstanceCreateInfo *create_info,
...
static void CASSIA_vkDestroySwapchainKHR(VkDevice device, VkSwapchainKHR swapchain,
        const VkAllocationCallbacks *allocator);

static VkResult CASSIA_vkCreateSwapchainKHR(VkDevice device,
...
err:
    CASSIA_vkDestroySwapchainKHR(device, (VkSwapchainKHR)swapchain, NULL);

    return result;
}

static VkResult CASSIA_vkCreateWin32SurfaceKHR(VkInstance instance,
...
static void CASSIA_vkDestroyInstance(VkInstance instance, const VkAllocationCallbacks *allocator)
{
    TRACE("%p %p\n", instance, allocator);
...
static void CASSIA_vkDestroySurfaceKHR(VkInstance instance, VkSurfaceKHR surface,
        const VkAllocationCallbacks *allocator)
{
...
static VkResult CASSIA_vkEnumerateInstanceExtensionProperties(const char *layer_name,
...
static VkResult CASSIA_vkGetDeviceGroupPresentCapabilitiesKHR(VkDevice device,
...
static VkResult CASSIA_vkGetDeviceGroupSurfacePresentModesKHR(VkDevice device,
...
static void *CASSIA_vkGetDeviceProcAddr(VkDevice device, const char *name)
{
    void *proc_addr;

    TRACE("%p, %s\n", device, debugstr_a(name));

    if ((proc_addr = CASSIA_get_vk_device_proc_addr(name)))
        return proc_addr;

    return pvkGetDeviceProcAddr(device, name);
}

static void *CASSIA_vkGetInstanceProcAddr(VkInstance instance, const char *name)
{
    void *proc_addr;

    TRACE("%p, %s\n", instance, debugstr_a(name));

    if ((proc_addr = CASSIA_get_vk_instance_proc_addr(instance, name)))
        return proc_addr;

    return pvkGetInstanceProcAddr(instance, name);
}

static VkResult CASSIA_vkGetPhysicalDevicePresentRectanglesKHR(VkPhysicalDevice phys_dev,
        VkSurfaceKHR surface, uint32_t *count, VkRect2D *rects)
{
    ...
    *count = 1;
    ERR("CASSIA_vkGetPhysicalDevicePresentRectanglesKHR is unimplemented!\n");
    return VK_ERROR_DEVICE_LOST;
}

static VkResult CASSIA_vkGetPhysicalDeviceSurfaceCapabilitiesKHR(VkPhysicalDevice phys_dev,
...
static VkResult CASSIA_vkGetPhysicalDeviceSurfaceCapabilities2KHR(VkPhysicalDevice phys_dev,
        const VkPhysicalDeviceSurfaceInfo2KHR *surface_info, VkSurfaceCapabilities2KHR *capabilities)
{
    ...
    return CASSIA_vkGetPhysicalDeviceSurfaceCapabilitiesKHR(phys_dev, surface_info->surface,
                                                             &capabilities->surfaceCapabilities);

}

// TODO: investigate bgra (needs opaque fd as ahwb doesn't support)
static VkResult CASSIA_vkGetPhysicalDeviceSurfaceFormats2KHR(VkPhysicalDevice phys_dev,
...
static VkResult CASSIA_vkGetPhysicalDeviceSurfaceFormatsKHR(VkPhysicalDevice phys_dev,
...
static VkResult CASSIA_vkGetPhysicalDeviceSurfacePresentModesKHR(VkPhysicalDevice phys_dev,
...
static VkResult CASSIA_vkGetPhysicalDeviceSurfaceSupportKHR(VkPhysicalDevice phys_dev,
...
static VkBool32 CASSIA_vkGetPhysicalDeviceWin32PresentationSupportKHR(VkPhysicalDevice phys_dev,
        uint32_t index)
{
    return true;
}

static VkResult CASSIA_vkGetSwapchainImagesKHR(VkDevice device,
...
static VkResult CASSIA_vkQueuePresentKHR(VkQueue queue, const VkPresentInfoKHR *present_info)
{
...
static VkSurfaceKHR CASSIA_wine_get_native_surface(VkSurfaceKHR surface)
{
    return surface;
}

static void *CASSIA_wine_get_adrenotools_mapping_handle(void)
{
...
{
    CASSIA_vkAcquireNextImage2KHR,
    CASSIA_vkAcquireNextImageKHR,
    CASSIA_vkCreateDevice,
    CASSIA_vkCreateInstance,
    CASSIA_vkCreateSwapchainKHR,
    CASSIA_vkCreateWin32SurfaceKHR,
    CASSIA_vkDestroyInstance,
    CASSIA_vkDestroySurfaceKHR,
    CASSIA_vkDestroySwapchainKHR,
    CASSIA_vkEnumerateInstanceExtensionProperties,
    CASSIA_vkGetDeviceGroupPresentCapabilitiesKHR,
    CASSIA_vkGetDeviceGroupSurfacePresentModesKHR,
    CASSIA_vkGetDeviceProcAddr,
    CASSIA_vkGetInstanceProcAddr,
    CASSIA_vkGetPhysicalDevicePresentRectanglesKHR,
    CASSIA_vkGetPhysicalDeviceSurfaceCapabilities2KHR,
    CASSIA_vkGetPhysicalDeviceSurfaceCapabilitiesKHR,
    CASSIA_vkGetPhysicalDeviceSurfaceFormats2KHR,
    CASSIA_vkGetPhysicalDeviceSurfaceFormatsKHR,
    CASSIA_vkGetPhysicalDeviceSurfacePresentModesKHR,
    CASSIA_vkGetPhysicalDeviceSurfaceSupportKHR,
    CASSIA_vkGetPhysicalDeviceWin32PresentationSupportKHR,
    CASSIA_vkGetSwapchainImagesKHR,
    CASSIA_vkQueuePresentKHR,

    CASSIA_wine_get_native_surface,
    CASSIA_wine_get_adrenotools_mapping_handle,
};
